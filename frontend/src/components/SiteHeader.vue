			...
			<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
				<div class="offcanvas-body">
					<ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
						<li class="nav-item" >
							<router-link class="nav-link active" aria-current="page" :to="{name: 'main'}" v-if="!GET_AUTH_TOKEN">Главная</router-link>
						</li>
            <li class="nav-item" >
            ...
            <li class="nav-item offset-lg-2" v-if="GET_AUTH_TOKEN">
              <form class="form-inline d-flex" @submit.prevent>
                ...
                <button class="btn btn-outline-success my-2 my-sm-0" @click="finds_users_by_username_from_api(users_search_value)">Искать</button>
						...
						<li class="nav-item" v-show="!GET_AUTH_TOKEN">
							<a class="nav-link" href="#">Контакты</a>
						</li>
						<li class="nav-item dropdown me-lg-3" v-if="!GET_AUTH_TOKEN">
						...
						<li class="nav-item ms-lg-3" v-if="!GET_AUTH_TOKEN"><router-link :to="{name: 'authentication'}"><a class="nav-link" href="#">Войти</a></router-link>
						</li>
						<li class="nav-item" v-if="!GET_AUTH_TOKEN"><router-link :to="{name: 'registration'}"><a class="nav-link" href="#">Зарегистрироваться</a></router-link>
						</li>
